...
class GlobFile:
    ...
    def __init__(self, config_file_path):
        ...
        self.log_amp = get_config_value(self.config, 'config_parameters', 'log_amp', 'NA', list)
        self.log_len = get_config_value(self.config, 'config_parameters', 'log_len', 'NA', list)
        ...
        config['config_inversion'].comments['npoint'] = ['', '# Number of living points during the nested sampling procedure.', 
                                                         "# Format : int",
                                                         "# MOSAIC : No"]
        config['config_inversion'].comments['hc_bounds_lsq'] = ['', '# Least-square bounds for high contrast modeling.', 
