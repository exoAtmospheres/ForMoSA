...
def add_filter(pathr, filter_name, unit, plot_filt=False):
    ...
    np.savez('/home/mravet/Documents/These/FORMOSA/ForMoSA_GP/ForMoSA/phototeque/' + filter_name, x_filt=x, y_filt=y)

add_filter('/home/mravet/Downloads/', 'SLOAN_SDSS.z', 'A', True)
