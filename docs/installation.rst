...
If you wish to use torch on CPU, you will need to have the right version on CUDA install on your device. Please follow the installation instructions from `PyTorch <https://pytorch.org/>`_.